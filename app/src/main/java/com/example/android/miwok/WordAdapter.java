...
*/
        final RelativeLayout textContainer = (RelativeLayout) listItemView.findViewById(R.id.text_container);
        textContainer.setBackgroundResource(mBackgroundColor);

        // Get the {@link Word} object located at this position in the list
        Word currentWord = getItem(position);

        TextView soundPlayer = (TextView) listItemView.findViewById(R.id.play_sound);
